(function(){
  ...
  const STATIC_CS={
    ...
    'ENTITY_TOPIC_ENRICHMENT':'ROZŠÍŘENÍ TEMATICKÉHO PROFILU ENTITY',
    ...
    'ANALYST_TRANSLATION':'PŘEKLAD ANALYTIKEM',
    'PRIMARY_OFFICIAL_CZECH_MILITARY':'PRIMÁRNÍ OFICIÁLNÍ ČESKÝ VOJENSKÝ ZDROJ',
    'PRIMARY_OFFICIAL_GERMAN_ARMY':'PRIMÁRNÍ OFICIÁLNÍ ZDROJ BUNDESWEHRU',
    'PRIMARY_US_GOV_RESEARCH_PROGRAM':'PRIMÁRNÍ ZDROJ VÝZKUMNÉHO PROGRAMU VLÁDY USA',
    'PRIMARY_OFFICIAL_US_DOD_MEDIA':'PRIMÁRNÍ OFICIÁLNÍ MÉDIUM DOD USA',
    'HIGH_FOR_PUBLISHED_PROFILE_MEDIUM_HIGH_FOR_2026_TEMPORAL_FRESHNESS':'VYSOKÁ PRO PUBLIKOVANÝ PROFIL; STŘEDNĚ VYSOKÁ PRO ČASOVOU AKTUÁLNOST V ROCE 2026',
    'MEDIUM_FOR_CAPTION_ASSOCIATION':'STŘEDNÍ PRO VAZBU PODLE OFICIÁLNÍHO POPISKU',
    'COMBAT_BREACHING':'BOJOVÉ PROLOMENÍ',
    'COMPETITIVE_PROTOTYPING_SELECTION_PRE_CONTRACT_AWARD':'VÝBĚR PRO KONKURENČNÍ PROTOTYPOVÁNÍ PŘED UDĚLENÍM KONTRAKTU',
    'RECENT_HISTORICAL_BACKFILL_PROGRAM_STATUS':'DODATEČNĚ DOPLNĚNÝ NEDÁVNÝ HISTORICKÝ STAV PROGRAMU',
    'FACT_ABOUT_OFFICIAL_PROGRAM_SELECTION':'FAKT O OFICIÁLNÍM VÝBĚRU V PROGRAMU',
    'HIGH_FOR_SELECTION_AND_STATED_ROADMAP_LOW_FOR_FUTURE_FIELDING':'VYSOKÁ PRO VÝBĚR A UVEDENÝ PLÁN; NÍZKÁ PRO BUDOUCÍ ZAVEDENÍ',
    'ENGINEER_INNOVATION_PROOF_OF_CONCEPT':'ŽENIJNÍ INOVAČNÍ OVĚŘENÍ KONCEPCE',
    'FACT_ABOUT_OFFICIAL_TRAINING_EXPERIMENT':'FAKT O OFICIÁLNÍM VÝCVIKOVÉM EXPERIMENTU',
    'HIGH_FOR_EVENT_AND_UNIT_ASSOCIATION_LOW_FOR_FIELDING':'VYSOKÁ PRO UDÁLOST A VAZBU NA JEDNOTKU; NÍZKÁ PRO ZAVEDENÍ',
    'PRIMARY_OFFICIAL_US_ARMY':'PRIMÁRNÍ OFICIÁLNÍ ZDROJ U.S. ARMY',
    'PRIMARY_OFFICIAL_US_ARMY_MEDIA':'PRIMÁRNÍ OFICIÁLNÍ MÉDIUM U.S. ARMY',
    'OFFICIAL_US_ARMY_PROGRAM_SELECTION':'OFICIÁLNÍ VÝBĚR V PROGRAMU U.S. ARMY',
    'PRIMARY_OFFICIAL_US_ARMY_ARTICLE':'PRIMÁRNÍ OFICIÁLNÍ ČLÁNEK U.S. ARMY',
    'OFFICIAL_US_ARMY_EVENT_REPORT':'OFICIÁLNÍ ZPRÁVA U.S. ARMY O UDÁLOSTI',
    'PRIMARY_OFFICIAL_US_ARMY_ARTICLE_INDEXED_CONTENT':'INDEXOVANÝ OBSAH PRIMÁRNÍHO OFICIÁLNÍHO ČLÁNKU U.S. ARMY',
    'PRIMARY_REPORT_WITH_LIVE_FETCH_RATE_LIMIT':'PRIMÁRNÍ ZPRÁVA S OMEZENÍM ŽIVÉHO NAČTENÍ',
    'HIGH_WITH_URL_FETCH_CAVEAT':'VYSOKÁ S VÝHRADOU K OMEZENÍ NAČTENÍ URL'
  };
