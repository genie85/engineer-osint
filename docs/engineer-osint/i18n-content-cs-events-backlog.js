(function(){
  ...
  D.translation_audit_cs.batches.push({batch:'2026-08-19-2036-evt-backlog',processed_ids:['ENG-EVT-0011','ENG-EVT-0012','ENG-EVT-0013','ENG-EVT-0020','ENG-EVT-0026'],fully_translated:5,partially_translated:0,review_needed:0,scope:'EVT backlog; translate exact audited missing Czech presentation fields for five materialized runtime records, including the public intelligence-gap/limit content on ENG-EVT-0020. Preserve English/base fields, mine-action context, classifications, confidence, temporal status and source/evidence meaning.',english_preserved:true});
  window.__ENGINEER_I18N_CONTENT_CS_EVENTS_BACKLOG__={translated_entities:['ENG-EVT-0011','ENG-EVT-0012','ENG-EVT-0013','ENG-EVT-0020','ENG-EVT-0026'].filter(id=>R.has(id)),review_needed_entities:[],version:'1.1',last_batch:'2026-08-19-2036-evt-backlog'};
})();
