...
import {LEGACY_FACTUAL_OVERLAY_MODULES,LOCALIZATION_DATA_MODULES} from './runtime-modules.mjs';
...
const modules=[...LEGACY_FACTUAL_OVERLAY_MODULES,...LOCALIZATION_DATA_MODULES].map(([,file])=>file);
