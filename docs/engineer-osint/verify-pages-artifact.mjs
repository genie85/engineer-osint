...
[
  ...
  `persistent_b98_parent_run=${b97}`,`persistent_b98_candidate_file_sha=${exactFileSha}`,`persistent_b98_result_sha=${exactCanonicalSha}`,
  'persistent_b98_persistent_gaps=15','persistent_b98_native_evidence=2','persistent_b98_native_assessments=4',
