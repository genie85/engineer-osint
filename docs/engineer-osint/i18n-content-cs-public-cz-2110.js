(function(){
  ...
  if(setLeadAll('LEAD-B35-01',{title_cs:'Geolokovaný úder z 17.–18. srpna na ruské minovací vozidlo poblíž Sudži — primární obrazový řetězec',topic_cs:'Geolokovaný úder z 17.–18. srpna na ruské minovací vozidlo poblíž Sudži — primární obrazový řetězec'}))translated.push('LEAD-B35-01');
  ...
  if(setLeadAll('LEAD-B35-03',{title_cs:'Výstupy panelů NATO MilEng WG / přesná veřejná metadata změn STANAG',topic_cs:'Výstupy panelů NATO MilEng WG / přesná veřejná metadata změn STANAG'}))translated.push('LEAD-B35-03');
  if(setLeadAll('LEAD-B36-01',{title_cs:'Oficiální týdenní metriky protiminové činnosti pro Charkov za 13.–19. srpna 2026',topic_cs:'Oficiální týdenní metriky protiminové činnosti pro Charkov za 13.–19. srpna 2026'}))translated.push('LEAD-B36-01');
  if(setLeadAll('LEAD-B36-02',{title_cs:'Aktuální ruský primární řetězec datovaných příspěvků a obrazových podkladů k ženijní/odminovací činnosti',topic_cs:'Aktuální ruský primární řetězec datovaných příspěvků a obrazových podkladů k ženijní/odminovací činnosti'}))translated.push('LEAD-B36-02');
  ...
  if(setLeadAll('LEAD-B36-04',{title_cs:'Nástupce / opětovná certifikace MKR-2 po 20. srpnu 2026 zůstává otevřenou otázkou',topic_cs:'Nástupce / opětovná certifikace MKR-2 po 20. srpnu 2026 zůstává otevřenou otázkou'}))translated.push('LEAD-B36-04');
  if(setLeadAll('LEAD-B37-01',{title_cs:'Vnitřní konzistence počtu/seznamu na ukrajinské stránce certifikace/akreditace protiminové činnosti',topic_cs:'Vnitřní konzistence počtu/seznamu na ukrajinské stránce certifikace/akreditace protiminové činnosti'}))translated.push('LEAD-B37-01');
  if(setLeadAll('LEAD-B37-02',{title_cs:'Aktuální ruský primární řetězec datovaných příspěvků a obrazových podkladů k ženijní/odminovací činnosti',topic_cs:'Aktuální ruský primární řetězec datovaných příspěvků a obrazových podkladů k ženijní/odminovací činnosti'}))translated.push('LEAD-B37-02');
  if(setLeadAll('LEAD-B37-03',{title_cs:'Cvičení překonávání vodní překážky v Koreji 20. srpna 2026 — aktuální atribuce prostředků z primárního zdroje',topic_cs:'Cvičení překonávání vodní překážky v Koreji 20. srpna 2026 — aktuální atribuce prostředků z primárního zdroje'}))translated.push('LEAD-B37-03');
  if(setLeadAll('LEAD-B37-04',{title_cs:'Přesná úplná definice EOC / normativní mapování nadřazeného dokumentu zůstává otevřené',topic_cs:'Přesná úplná definice EOC / normativní mapování nadřazeného dokumentu zůstává otevřené'}))translated.push('LEAD-B37-04');
