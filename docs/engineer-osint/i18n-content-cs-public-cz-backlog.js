(function(){
  ...
  D.translation_audit_cs.batches.push({batch:'2026-08-21-1937-leads-011-018',processed_ids:[...new Set([...translated,...qualityFixed,...review,'ENG-EVID-0131','ENG-EVID-0132','ENG-DOC-0042','ENG-EVID-0133'])],fully_translated:qualityFixed.length+translated.length+4,partially_translated:0,review_needed:review.length,scope:'PUBLIC-CZ-UI: LEAD-011 až LEAD-018 – doplnění českých dalších kroků podle materializovaných anglických polí; oficiální názvy, zkratky a systémová označení zachována. EN pole a factual registry data zachována.',english_preserved:true});
  window.__ENGINEER_I18N_CONTENT_CS_PUBLIC_CZ__={translated_entities:[...new Set([...translated,...qualityFixed,'ENG-EVID-0131','ENG-EVID-0132','ENG-DOC-0042','ENG-EVID-0133'])],review_needed_entities:review,resolved_mapping_entities:['PUBLIC_REGISTRIES','PUBLIC_EXTERNAL_LEADS','PUBLIC_REGISTRY_ENUMS','PUBLIC_STATUS_ENUM','PUBLIC_CURRENT_VALUE_STATUS','PUBLIC_OBSERVATION_BASIS','PUBLIC_URL_VALIDATION_STATUS','B16_B17_TRENDS','B18_PUBLIC_ENUMS','B19_EUGS_ENUMS','B19_EVIDENCE_ENUMS','B20_WIT_ENUMS','P1_LEADS_001_018','PUBLIC_CZ_HYBRID_TEXT','PUBLIC_UI_ENUM_HYBRIDS','AUDIT_VM_SAFE'],version:'2.2',last_batch:'2026-08-21-1937-leads-011-018'};
})();
