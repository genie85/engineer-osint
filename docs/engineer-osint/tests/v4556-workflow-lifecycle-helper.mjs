...
const b106IdentityWorkflowSha='e44cb9caf5fc61c83ad254f7b829977245abec49';
...
function assertExactV4565ActionUpgradeSuccessor(item,text,current){
  ...
  if(exactPublishedDescendant){
    ...
    if([b101IdentityWorkflowSha,b102IdentityWorkflowSha,b103IdentityWorkflowSha,b104IdentityWorkflowSha,b105IdentityWorkflowSha,b106IdentityWorkflowSha].includes(current))assert.match(text,/'engineer-osint-20260902-B101':'c8c134daff25a15b3825680f5e033d83a833f87910e2c94421adf634ee7a7acd'/,'B101 exact digest anchor missing');
    if([b102IdentityWorkflowSha,b103IdentityWorkflowSha,b104IdentityWorkflowSha,b105IdentityWorkflowSha,b106IdentityWorkflowSha].includes(current))assert.match(text,/'engineer-osint-20260902-B102':'5122d347541c53638a59c8f3c855c417db8ae2ea5a04b002948d655d91b5e6d7'/,'B102 exact digest anchor missing');
    if([b103IdentityWorkflowSha,b104IdentityWorkflowSha,b105IdentityWorkflowSha,b106IdentityWorkflowSha].includes(current))assert.match(text,/'engineer-osint-20260902-B103':'68892883c8acc3dbdd7d9acc2e2d48682ac61008ad8b8a49f55c01fbef71e87a'/,'B103 exact digest anchor missing');
    if([b104IdentityWorkflowSha,b105IdentityWorkflowSha,b106IdentityWorkflowSha].includes(current))assert.match(text,/'engineer-osint-20260903-B104':'5c931288915f7621771bbaa904814b63d8ab7b18461900c077ad85fc6279798c'/,'B104 exact digest anchor missing');
    if([b105IdentityWorkflowSha,b106IdentityWorkflowSha].includes(current))assert.match(text,/'engineer-osint-20260904-B105':'25157418735741c5deec91f8ced48a920fd2086bf20d38df95277e03568f13c7'/,'B105 exact digest anchor missing');
    if(current===b106IdentityWorkflowSha)assert.match(text,/'engineer-osint-20260904-B106':'52ab8b1d862de74128cd25e49b46f4cbb3d316cc8b8413850781a46aa6a8200c'/,'B106 exact digest anchor missing');
