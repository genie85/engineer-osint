...
test('v4.5.94 executes the separately authorized B100 append as the canonical head',()=>{
...
test('v4.5.94 installs exactly the reviewed B100 append guard and preserves protected implementation baselines',()=>{
  assert.equal(gitBlobSha(readFileSync('docs/engineer-osint/append-run.mjs','utf8')),'7edb68db4950d011b18de0ca7bf1e2655bdbdbf0');
