...
test('v4.5.66 keeps immutable policy and recognizes only baseline/action/B100/B101/B102 lifecycle successors',()=>{
  ...
  assert.ok([policy.authorized_test.historical_git_blob_sha,exactV4565TestSuccessor,exactB100V4565TestSuccessor,exactB101V4565TestSuccessor,exactB102V4565TestSuccessor].includes(current),'v4.5.65 test is outside the exact pinned lifecycle states');
