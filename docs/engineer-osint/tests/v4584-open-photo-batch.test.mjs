...
assert.match(byId.get('ENG-TECH-0018').license_evidence, /public domain/i);
...
assert.match(byId.get('ENG-TECH-0019').license_evidence, /Creative Commons Attribution 2\.0/i);
...
assert.match(byId.get('ENG-TECH-0020').license_evidence, /CC BY 4\.0|Creative Commons Attribution 4\.0/i);
