...
test('v4.5.62 exact workflow history permits action successors plus exact B100/B101/B102/B103 identity successors', () => {
  for (const item of migration.workflows) {
    ...
    if (item.role === 'ACTIVE_PRODUCTION_PROTECTION') {
      ...
      if(item.file==='identity-fix-retirement-regression.yml'){
        assert.ok([successor.v4564_diagnostic_git_blob_sha,b100IdentityWorkflowSha,b101IdentityWorkflowSha,b102IdentityWorkflowSha,b103IdentityWorkflowSha].includes(currentSha),`${item.file}: unauthorized action/publication successor blob`);
        if([b100IdentityWorkflowSha,b101IdentityWorkflowSha,b102IdentityWorkflowSha,b103IdentityWorkflowSha].includes(currentSha)){
          ...
          if([b101IdentityWorkflowSha,b102IdentityWorkflowSha,b103IdentityWorkflowSha].includes(currentSha))assert.match(content,/'engineer-osint-20260902-B101':'c8c134daff25a15b3825680f5e033d83a833f87910e2c94421adf634ee7a7acd'/);
          if([b102IdentityWorkflowSha,b103IdentityWorkflowSha].includes(currentSha))assert.match(content,/'engineer-osint-20260902-B102':'5122d347541c53638a59c8f3c855c417db8ae2ea5a04b002948d655d91b5e6d7'/);
          if(currentSha===b103IdentityWorkflowSha)assert.match(content,/'engineer-osint-20260902-B103':'68892883c8acc3dbdd7d9acc2e2d48682ac61008ad8b8a49f55c01fbef71e87a'/);
