...
test('v4.5.57 historical browser successor remains pinned while B100/B101/B102 have exact descendants',()=>{
  ...
  assert.ok([b100Successor,b101Successor,b102Successor].includes(gitBlobSha(workflow)));
  assertV4557Applied();
});

test('v4.5.57 keeps historical digest and exact B100/B101/B102 fail-closed descendant digests',()=>{
  ...
  if([b101Successor,b102Successor].includes(gitBlobSha(workflow)))assert.match(workflow,/'engineer-osint-20260902-B101':'c8c134daff25a15b3825680f5e033d83a833f87910e2c94421adf634ee7a7acd'/);
  if(gitBlobSha(workflow)===b102Successor)assert.match(workflow,/'engineer-osint-20260902-B102':'5122d347541c53638a59c8f3c855c417db8ae2ea5a04b002948d655d91b5e6d7'/);
