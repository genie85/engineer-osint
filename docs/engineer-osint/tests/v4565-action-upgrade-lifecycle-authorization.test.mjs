...
test('v4.5.65 preserves immutable baselines and recognizes only pinned historical/action/B100/B101 test successors',()=>{
  ...
  assert.ok(baselineTestMode||successorTestMode||b100TestMode||b101TestMode,'lifecycle tests are a mixed or unauthorized state');
...
test('v4.5.65 keeps historical workflow successors immutable and permits only exact B100/B101 browser successors',()=>{
  ...
  assert.ok(baselineWorkflowMode||successorWorkflowMode||b100WorkflowMode||b101WorkflowMode,'workflows are a mixed or unauthorized lifecycle state');
  ...
  if(b100WorkflowMode||b101WorkflowMode){
