...
const nextV4673aSuccessor='6f93795d7522d8c182cc69affe0e3c5139b785c0';
...
test('v4.6.75a remains lifecycle-compatible with exact historical, corrected and next V4673A successors',()=>{
  ...
  assert.ok([auth.authorized_target.source_git_blob_sha,auth.authorized_target.successor_git_blob_sha,correction.authorized_target.replacement_successor_git_blob_sha,nextV4673aSuccessor].includes(blob),'V4673A regression test must be exact source, exact historical successor, exact corrected successor, or exact pinned next successor');
});
