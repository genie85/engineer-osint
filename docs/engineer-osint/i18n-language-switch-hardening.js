(function(){
  ...
  // The base i18n controller owns language state, click handling and rendering.
  // This module only moves the already-live control outside the body subtree so
  // view-level body/main rerenders cannot detach its original onclick handler.
